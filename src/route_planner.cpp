...
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y, float end_x, float end_y): m_Model(model) {
    ...
    // COMPLETE Use the m_Model.FindClosestNode method to find the closest nodes to the starting and ending coordinates.
...
// COMPLETE Implement the CalculateHValue method.
// Tips:
...
// COMPLETE: Complete the ConstructFinalPath method to return the final path found from your A* search.
// Tips:
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    // COMPLETE: Implement your solution here.
